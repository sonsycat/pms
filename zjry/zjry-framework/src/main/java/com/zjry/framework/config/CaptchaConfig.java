...
public class CaptchaConfig
{
    ...
    public DefaultKaptcha getKaptchaBean()
    {
        ...
        //背景颜色渐变，结束颜色
        properties.setProperty(KAPTCHA_BACKGROUND_CLR_TO, "gray");
        //文字渲染器
        properties.setProperty(KAPTCHA_WORDRENDERER_IMPL, "com.google.code.kaptcha.text.impl.DefaultWordRenderer");
        //文本集合，验证码值从此集合中获取
        properties.setProperty(KAPTCHA_TEXTPRODUCER_CHAR_STRING, "3456789ABCDEFGJKMPQRSTUVWXY");
    ...
    public DefaultKaptcha getKaptchaBeanMath()
    {
        ...
        // 验证码文本生成器
        properties.setProperty(KAPTCHA_TEXTPRODUCER_IMPL, "com.zjry.framework.config.KaptchaTextCreator");
        // 验证码文本字符间距 默认为2
