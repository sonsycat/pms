...
import com.zjry.system.service.ISysRoleService;
...
public class SysUserController extends BaseController {
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:user:edit')")
    @Log(title = "切换角色", businessType = BusinessType.GRANT)
    @PostMapping("/changeRole")
    public AjaxResult changeRole(Long roleId)
    {
        if(userService.changeRole(roleId)) {
        	return success();
        } else {
        	// 非法角色，不可切换
        	return error("非法角色，不可切换！");
        }
    }
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:user:edit')")
    @Log(title = "切换机构", businessType = BusinessType.GRANT)
    @PostMapping("/changeDept")
    public AjaxResult changeDept(Long deptId)
    {
        userService.changeDept(deptId);
    	return success();
    }
