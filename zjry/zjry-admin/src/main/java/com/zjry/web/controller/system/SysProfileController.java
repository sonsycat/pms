...
//            LoginUser loginUser = tokenService.getLoginUser(ServletUtils.getRequest());
    ...
    public AjaxResult avatar(@RequestParam("avatarfile" ) MultipartFile file) throws IOException {
        if (!file.isEmpty()) {
            LoginUser loginUser = tokenService.getLoginUser(ServletUtils.getRequest());
            String avatar = FileUploadUtils.upload(ZjRyConfig.getAvatarPath(), file);
     ...
     * 获取版本信息
     */
    @GetMapping("/getZjryConfig" )
    @ApiOperation("获取版本信息" )
    public AjaxResult getZjryConfig() {
        return AjaxResult.success(zjRyConfig);
    }
}
