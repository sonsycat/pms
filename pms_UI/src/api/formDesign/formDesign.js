...
export function listFormDesign(query) {
  return request({
    url: '/formDesign/formDesign/list',
    method: 'get',
    params: query
  })
}
...
export function listFormSort(query) {
  return request({
    url: '/formDesign/formDesign/selectForSortNo',
    method: 'get',
    params: query
  })
}
...
export function setPageNo(data) {
  return request({
    url: '/formDesign/formDesign/setPageNo',
    method: 'put',
    data:data
  })
}
...
export function editTableItem(data) {
  return request({
    url: '/formDesignField/updateFormDesignField',
    method: 'post',
    data:data
  })
}
...
export function selectDictType(data) {
  return request({
    url: '/formDesignField/selectDictType',
    method: 'get',
    params:data
  })
}
...
export function exportFormDesign(query) {
  return request({
    url: '/formDesign/formDesign/export',
    method: 'get',
    params: query
  })
}
...
export function checkFormCodeUnique(formCode) {
  return request({
    url: '/formDesign/formDesign/checkFormCodeUnique?formCode=' + formCode,
    method: 'get'
  })
}
