...
export function archiveCalculation(id) {
  return request({
    url: '/bonus/calculationNew/archive/'+id,
    method: 'post'
  })
}
...
export function bonusDetail(id) {
  return request({
    url: '/bonus/calculationNew/detail/' + id,
    method: 'get'
  })
}
...
export function getProId(data) {
  return request({
    url: '/bonus/calculationNew/get/proId',
    method: 'post',
    data: data
  })
}
export function bonusAudit(data) {
  return request({
    url: '/bonus/calculationNew/bonusAudit',
    method: 'post',
    data: data
  })
}
export function bonusCommit(data) {
  return request({
    url: '/bonus/calculationNew/bonusCommit',
    method: 'post',
    data: data
  })
}
