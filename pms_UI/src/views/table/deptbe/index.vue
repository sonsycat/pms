  ...
  <div class="app-container">
    <div ref="search">
      <el-form :model="queryParams" ref="queryForm" :inline="true" :rules="rules">
        ...
        <el-form-item label="操作类型:" prop="opTag">
          <el-select class="search_w220" v-model="queryParams.opTag" clearable placeholder="请选择操作类型">
            <el-option
              v-for="dict in opTagList"
              :key="dict.opTagValue"
              :label="dict.opTagLabel"
              :value="dict.opTagValue"
            ></el-option>
          </el-select>
        </el-form-item>
...
<script>
import {  listDeptbeList,exportDetail} from "@/api/table/deptbe";
...
export default {
  ...
  data() {
    return {
      ...
      deptMesList: [],
      opTagList: [
        { opTagLabel: '开单', opTagValue: '1',},
        { opTagLabel: '执行', opTagValue: '0',},
         ],
      isReckList: [
  ...
  methods:{
    ...
    getList(){
      this.loading = true;
      listDeptbeList(this.queryParams).then(response => {
