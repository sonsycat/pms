<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column align="center" prop="className" label="核算科目" fixed width="100" />
      <el-table-column align="center" prop="accountincomes" label="总收入" fixed width="120" />
      <el-table-column align="center" label="实际收入">
        <el-table-column align="center" label="小计" prop="facaccountincomes"></el-table-column>
        <el-table-column align="center" label="门诊" prop="armaccountincomes"></el-table-column>
        <el-table-column align="center" label="住院" prop="hrealincomes"></el-table-column>
      </el-table-column>
      <el-table-column align="center" label="计价收入">
        <el-table-column align="center" label="小计" prop="hvalationincomes"></el-table-column>
        <el-table-column align="center" label="门诊" prop="crealincomes"></el-table-column>
        <el-table-column align="center" label="住院" prop="cvalationincomes"></el-table-column>
      </el-table-column>
    </el-table>
...
<script>
import {  listHsdeptList,exportDetail} from "@/api/table/hsdept";
...
export default {
  ...
  methods:{
    ...
    getList(){
      this.loading = true;
      listHsdeptList(this.queryParams).then(response => {
