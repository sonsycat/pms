<template>
  ...
  <div ref="search">
    ...
    <el-table :height="tableHeight" border stripe v-loading="loading" :data="inputList" @selection-change="handleSelectionChange" ref="multipleTable" @row-click="rowClick" :row-style="rowStyle" :row-class-name="rowClassName">
