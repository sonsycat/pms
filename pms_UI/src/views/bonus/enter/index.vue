...
<!--      </el-col>-->
      ...
      <el-col :span="1.5">
        <el-button
          ...
          v-hasPermi="['bonus:enter:exportDetail']"
        >导出</el-button>
      </el-col>
    ...
    <el-table border :height="tableHeight" stripe v-loading="loading" :data="enterList" @selection-change="handleSelectionChange" ref="multipleTable" @row-click="rowClick" :row-style="rowStyle" :row-class-name="rowClassName">
      ...
      <el-table-column sortable label="姓名" align="center" prop="userName" />
      <el-table-column sortable label="绩效" align="center" prop="achievement" />
      ...
      >
        ...
        <div class="el-upload__tip" slot="tip">
          <el-form ref="form" :model="form" :rules="rules" label-width="80px">
            <el-form-item label="时间" prop="enterTime" >
...
<script>
import { listEnter, delEnter, exportDetail, exportEnter } from "@/api/bonus/enter";
  ...
  data() {
    return {
      ...
      upload: {
        ...
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + "/bonus/enter/importData"
      },
    };
  },
  created() {
...
//  	console.log(fileList);
    ...
    handleExport() {
      const queryParams = this.queryParams;
      this.exportLoading = true;
      exportEnter(queryParams).then(response => {
        this.download(response.msg);
        this.exportLoading = false;
      }).catch(() => {});
    },
