      ...
      <el-row :gutter="10" class="mb8">
        <el-col :span="1.5">
          <el-button
            ...
            size="mini"
            @click="handleAdd"
            v-hasPermi="['bonus:calculationNew:add']"
          >生成新奖金
          </el-button>
        </el-col>
        <el-col :span="1.5">
          <el-button
            ...
            :disabled="detailFlag"
            @click="showDetail"
            v-hasPermi="['bonus:calculationNew:detail']"
          >查看详情
          </el-button>
        </el-col>
        <el-col :span="1.5">
        ...
        <el-col :span="1.5">
          <el-button
            ...
            :disabled="submitFlag"
            @click="handleCommit"
            v-hasPermi="['bonus:calculationNew:commit']"
          >提交
          </el-button>
        </el-col>
        <el-col :span="1.5">
          <el-button
            ...
            :disabled="single"
            @click="handleAudit"
            v-hasPermi="['bonus:calculationNew:audit']"
          >审核
          </el-button>
        </el-col>
<!--        <el-col :span="1.5">-->
...
<!--        </el-col>-->
        <el-col :span="1.5">
          <el-button
            ...
            :disabled="single"
            @click="archive"
            v-hasPermi="['bonus:calculationNew:archive']"
          >归档
          </el-button>
        </el-col>
    ...
    <audit v-if="open2" :open="open2" :id="addEditId"  :auditName="auditName" :auditDate="auditDate" @cancel="cancel2"
    @success="successSubmit2"></audit>
    <!-- 流转历史对话框 -->
  ...
  methods: {
    ...
    showDetail(row) {
      if(this.selectionRow && this.selectionRow.length > 0){
        ...
        this.$router.push('/calculationNew/detail/' + this.selectionRow[0].period)
      }
    },
    /** 提交按钮 */
    submitForm() {
    ...
    handleAudit(row) {
      ...
      this.auditName = this.selectionRow[0].name
      this.auditDate = this.selectionRow[0].period
      // bonusAudit({ id: id }).then(res=>{
      //   if(res.code == 200){
