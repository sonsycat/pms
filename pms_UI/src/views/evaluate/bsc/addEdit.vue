<template>
  <el-dialog :title="title" :visible.sync="openDialog" width="40%" custom-class="el-button--primary" append-to-body
    ...
    <el-form ref="form" :model="form" :rules="rules" label-width="80px">
      <el-row>
        <el-col :span="24">
        <el-form-item label="BSC类别编码" prop="bscCode">
          <el-input v-model="form.bscCode" placeholder="系统生成类别编码" disabled="true" maxlength="50" show-word-limit/>
        </el-form-item>
        </el-col>
        <el-col :span="24">
        <el-form-item label="BSC类别名称" prop="bscName">
          <el-input v-model="form.bscName" placeholder="请输入BSC类别名称" maxlength="100" show-word-limit/>
        </el-form-item>
        </el-col>
        <el-col :span="24">
...
<script>
  ...
  import {listBsc, getBsc, delBsc, addBsc, updateBsc, exportBsc} from "@/api/evaluate/bsc";
  import bscSelect from "@/views/components/bscList/index"
  ...
  export default {
    ...
    methods: {
      ...
      // 配送条件字典翻译
      deliveryFormat(row, column) {
        return this.selectDictLabel(this.deliveryOptions, row.delivery);
      },
