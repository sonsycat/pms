<template>
  ...
  <div ref="search">
    ...
    <el-table border stripe v-loading="loading" :data="indexList" :height="tableHeight" @selection-change="handleSelectionChange" ref="multipleTable" @row-click="rowClick" :row-style="rowStyle" :row-class-name="rowClassName">
      ...
      <el-table-column sortable label="BSC一级分类" align="center" prop="bscOneName" min-width="150px"/>
      <el-table-column sortable label="BSC二级分类" align="left" prop="bscSecondName" min-width="150px"/>
        ...
        <el-form ref="formIn" :model="indicatorData" :rules="rules" label-width="80px">
            ...
            <el-row :gutter="15" class="h100">
                <el-col :span="6" class="h100">
                    <el-card class="box-card h100 card-l">
                    <div class="h100">
                ...
                <el-col :span="12" class="h100">
                    ...
                    <el-col :span="24" class="mt10">
                      <el-row>
                                ...
                                <el-button class="btns" size="mini" @click="handleEmpty">清空</el-button>
                                </el-row>
                    <el-row>
                ...
                <el-col :span="6" class="h100">
                    <el-card class="box-card h100 card-r">
                    <div slot="header" class="clearfix">
                        <span>公式函数列表</span>
                    </div>
                    <div class="h100">
...
<script>
import { listIndex, getIndex, delIndex, addIndex, updateIndex, exportIndex, getBsc, getIndicatorList } from "@/api/evaluate/index";
