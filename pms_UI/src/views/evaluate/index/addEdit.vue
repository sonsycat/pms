      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="顺序号" prop="indexSort">
            <el-input-number class="w90" controls-position="right" v-model="form.indexSort" placeholder="请输入顺序号" :min="0"/>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
...
import { listIndex, getIndex, addIndex, updateIndex, getBsc } from "@/api/evaluate/index";
