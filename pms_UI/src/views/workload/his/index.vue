<template>
  ...
  <div ref="search">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['commission:his:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['commission:his:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['commission:his:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table border stripe v-loading="loading" :data="hisList" @selection-change="handleSelectionChange" ref="multipleTable" @row-click="rowClick" :row-style="rowStyle" :row-class-name="rowClassName">
      ...
      <el-table-column label="操作" align="center" fixed="right">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['commission:his:edit']" title="修改"
          ></el-button>
          <el-button
            size="mini"
            type="text"
            ...
            v-hasPermi="['commission:his:remove']" title="删除"
          ></el-button>
        </template>
      </el-table-column>
    </el-table>
...
addEdit
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除工作量-HIS收费项目编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有工作量-HIS收费项目数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(() => {
