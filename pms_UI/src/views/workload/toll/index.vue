<template>
  ...
  <div ref="search">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['commission:toll:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['commission:toll:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['commission:toll:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['commission:toll:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table border stripe v-loading="loading" :data="tollList" @selection-change="handleSelectionChange" ref="multipleTable" @row-click="rowClick" :row-style="rowStyle" :row-class-name="rowClassName">
      ...
      <el-table-column sortable label="收费项目名称" align="center" prop="hisName" />
      <el-table-column sortable label="收费项目编码" align="center" prop="hisCode" />
      ...
      <el-table-column label="操作" align="center" fixed="right">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['commission:toll:edit']" title="修改"
          ></el-button>
          <el-button
            size="mini"
            type="text"
            ...
            v-hasPermi="['commission:toll:remove']" title="删除"
          ></el-button>
        </template>
      </el-table-column>
    </el-table>
...
addEdit
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除工作量-收费项设置编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有工作量-收费项设置数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(() => {
          this.exportLoading = true;
          return exportToll(queryParams);
        }).then(response => {
