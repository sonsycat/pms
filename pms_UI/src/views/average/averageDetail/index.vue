<template>
  ...
  <div ref="search">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['average:averageDetail:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['average:averageDetail:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['average:averageDetail:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['average:averageDetail:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table border stripe v-loading="loading" :data="averageDetailList" @selection-change="handleSelectionChange" ref="multipleTable" @row-click="rowClick" :row-style="rowStyle" :row-class-name="rowClassName">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column sortable label="责任奖系数" align="center" prop="id" />
      <el-table-column sortable label="科室名称" align="center" prop="deptName" />
      <el-table-column sortable label="医生名称" align="center" prop="docName" />
      ...
      <el-table-column label="操作" align="center" fixed="right">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['average:averageDetail:edit']" title="修改"
          ></el-button>
          <el-button
            size="mini"
            type="text"
            ...
            v-hasPermi="['average:averageDetail:remove']" title="删除"
          ></el-button>
        </template>
      </el-table-column>
    </el-table>
...
addEdit
  ...
  methods: {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有平均奖科人数明细数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(() => {
          this.exportLoading = true;
          return exportAverageDetail(queryParams);
        }).then(response => {
