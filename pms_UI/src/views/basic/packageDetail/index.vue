<template>
  ...
  <div ref="search">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['basic:packageDetail:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['basic:packageDetail:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['basic:packageDetail:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['basic:packageDetail:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table border stripe v-loading="loading" :data="packageDetailList" @selection-change="handleSelectionChange" ref="multipleTable" @row-click="rowClick" :row-style="rowStyle" :row-class-name="rowClassName">
      ...
      <el-table-column sortable label="套包编号" align="center" prop="packageCode" />
      <el-table-column sortable label="物资编码" align="center" prop="materialCode" />
      <el-table-column sortable label="包内数量" align="center" prop="quantity" />
      ...
      <el-table-column label="操作" align="center" fixed="right">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['basic:packageDetail:edit']" title="修改"
          ></el-button>
          <el-button
            size="mini"
            type="text"
            ...
            v-hasPermi="['basic:packageDetail:remove']" title="删除"
          ></el-button>
        </template>
      </el-table-column>
    </el-table>
...
addEdit
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除术式套包字典管理明细编号为"' + ids + '"的数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
          return delPackageDetail(ids);
        }).then(() => {
          this.getList();
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有术式套包字典管理明细数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(() => {
          this.exportLoading = true;
          return exportPackageDetail(queryParams);
        }).then(response => {
