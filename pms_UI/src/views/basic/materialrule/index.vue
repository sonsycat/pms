  ...
  <div ref="search">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="物资类型" prop="materialType">
        <el-select v-model="queryParams.materialType" placeholder="请选择物资类型" clearable size="small">
          <el-option
      ...
      <el-form-item label="条码类型" prop="barType">
        <el-select v-model="queryParams.barType" placeholder="请选择条码类型" clearable size="small">
          <el-option
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['basic:materialrule:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['basic:materialrule:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['basic:materialrule:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['basic:materialrule:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table border stripe v-loading="loading" :data="materialruleList" @selection-change="handleSelectionChange" ref="multipleTable" @row-click="rowClick" :row-style="rowStyle" :row-class-name="rowClassName">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column sortable label="条码类型" align="center" prop="id" />
      <el-table-column sortable label="物资类型" align="center" prop="materialType" :formatter="materialTypeFormat" />
      <el-table-column sortable label="条码类型" align="center" prop="barType" :formatter="barTypeFormat" />
      <el-table-column label="操作" align="center" fixed="right">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['basic:materialrule:edit']" title="修改"
          ></el-button>
          <el-button
            size="mini"
            type="text"
            ...
            v-hasPermi="['basic:materialrule:remove']" title="删除"
          ></el-button>
        </template>
      </el-table-column>
    </el-table>
...
addEdit
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除编码规则编号为"' + ids + '"的数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
          return delMaterialrule(ids);
        }).then(() => {
          this.getList();
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有编码规则数据项?', "警告", {
          ...
          return exportMaterialrule(queryParams);
        }).then(response => {
