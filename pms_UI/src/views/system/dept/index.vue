<template>
  <div class="app-container">
    ...
    >
      <el-table-column prop="deptName" align="left" label="部门名称" min-width="350"></el-table-column>
      <el-table-column prop="orderNum" label="排序" min-width="200"></el-table-column>
      <el-table-column prop="status" label="状态" :formatter="statusFormat" min-width="100"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    load(tree, treeNode, resolve){
      console.log(tree)
      listDept({
        parentId: tree.deptId}).then(response => {
