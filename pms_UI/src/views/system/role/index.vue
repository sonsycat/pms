<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="角色名称" align="left" prop="roleName" :show-overflow-tooltip="true" min-width="150" />
...
<!--          ></el-button>-->
    ...
    <!-- 分配角色数据权限对话框 -->
    <el-dialog :title="title" :visible.sync="openDataScope" width="500px" append-to-body custom-class="el-button--primary">
