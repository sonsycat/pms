      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          ...
          <el-col :span="12">
            ...
            <el-form-item label="用户昵称" prop="nickName" v-if="form.userType != '02'">
              <!-- <el-input v-model="form.nickName" placeholder="请输入用户昵称" /> -->
              <el-input v-model="form.nickName" placeholder="请选择用户" maxlength="50" disabled v-on:click.native="selectDoctor()"/>
              <!-- <el-input v-model="form.empCode" type="hidden"  v-show="false"/> -->
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="form.userType == '02'">
            <el-form-item label="供应商名称" prop="nickName">
              <el-input v-model="form.nickName" placeholder="系统自动带出" readonly/>
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="form.userType != '02'">
        ...
        <!-- <el-row>
          <el-col :span="24">
            <el-form-item label="医生" prop="docCode">
              <el-input v-model="form.docName" placeholder="请选择医生" maxlength="50" disabled v-on:click.native="selectDoctor()"/>
              <el-input v-model="form.docCode" type="hidden"  v-show="false"/>
            </el-form-item>
          </el-col>
        </el-row> -->
          <el-col :span="24">
...
// import supplierPopover from "@/views/components/supplierPopover";
