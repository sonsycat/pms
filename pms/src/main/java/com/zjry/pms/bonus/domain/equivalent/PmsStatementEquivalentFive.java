...
@Data
public class PmsStatementEquivalentFive {
//    @Excel(name = "病区代码")
...
//    private String userName;
    @Excel(name = "医疗组代码",sort = 4)
    private String zlCode;
    @Excel(name = "核算名称",sort = 7)
    private String className;
    @Excel(name = "医疗组名称",sort = 5)
    private String zlName;
    @Excel(name = "核算代码",sort = 6)
    private String classOnReckoning;
    @Excel(name = "项目代码",sort = 8)
    private String itemCode;
    @Excel(name = "项目名称",sort = 9)
    private String itemName;
    @Excel(name = "物价",sort = 10)
    private String itemPrice;
    @Excel(name = "数量",sort = 11)
    private String number;
    @Excel(name = "标准当量",sort = 12)
    private String bzNum;
    @Excel(name = "绩效当量",sort = 13)
