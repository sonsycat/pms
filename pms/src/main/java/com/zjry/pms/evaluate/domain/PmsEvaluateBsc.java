...
import lombok.Data;
/**
 * BSC分类对象 pms_evaluate_bsc
 *
 * @author mk
 * @date 2022-08-01
 */
@Data
@ApiModel(value = "PmsEvaluateBsc", description = "BSC分类对象 pms_evaluate_bsc")
public class PmsEvaluateBsc extends BaseEntity implements Serializable {
    ...
    /** BSC类别编码 */
    @Excel(name = "BSC类别编码")
    @ApiModelProperty(value = "BSC类别编码")
    private String bscCode;

    /** BSC类别名称 */
    @Excel(name = "BSC类别名称")
    @ApiModelProperty(value = "BSC类别名称")
