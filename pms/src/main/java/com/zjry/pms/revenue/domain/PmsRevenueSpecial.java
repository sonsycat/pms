...
import lombok.Data;
/**
 * 特殊收入项目方案对象 pms_revenue_special
 *
 * @author maozt
 * @date 2022-06-21
 */
@Data
@ApiModel(value = "PmsRevenueSpecial", description = "特殊收入项目方案对象 pms_revenue_special")
public class PmsRevenueSpecial extends BaseEntity implements Serializable {
