 ...
 * @date 2022-05-12
 */
public interface CostApportionmentDictionaryDetailMapper extends BaseMapper<CostApportionmentDictionaryDetail> {
    /**
     * 查询比例分摊字典明细
     * 
     * @param id 比例分摊字典明细ID
     ...
     * 删除比例分摊字典明细
     * 
     * @param code 比例分摊字典明细code
     * @return 结果
     */
    public int deleteCostApportionmentDictionaryDetailByCode(String code);
