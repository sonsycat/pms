package com.zjry.pms.pmsFormDesign.domain;
 ...
 * @author Yangtao
 */
public class PmsFormDesignField extends BaseEntity {
	...
	private List<PmsFormDesignField> fdcList;

	public List<PmsFormDesignField> getFdcList() {
		return fdcList;
	}
	public void setFdcList(List<PmsFormDesignField> fdcList) {
