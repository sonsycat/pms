...
import com.zjry.pms.table.domain.PmsTableDeptarRes;
...
public class ExcelDeptarUtils {
    public static Workbook buildData(Workbook wb, List<PmsTableDeptarRes> list) throws IOException {
        // 创建sheet页
        ...
        if(null !=list && list.size()>0){
            for (int i = 0; i < list.size(); i++) {
                PmsTableDeptarRes excelDto = list.get(i);
